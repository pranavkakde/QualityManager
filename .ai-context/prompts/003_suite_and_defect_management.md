...
* **Visuals:** Grid cards representing executable suites (e.g. Authentication Suite, Checkout Suite) with descriptions and an "Add Suite" button trigger at the top right.
